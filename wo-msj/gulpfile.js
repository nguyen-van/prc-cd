...
//  },
 ...
 // },
  path: {
    ...
    sass: {
      src: './wp-content/themes/wp/assets/scss/**/*.scss',
      dest: './wp-content/themes/wp/',
    },
//    js: {
...
gulp.task('watch', function(){
  ...
  gulp.watch(['./wp-content/themes/wp/**/*.js'],　{interval: 0}, browserSync.reload);
  gulp.watch(['./wp-content/themes/wp/**/*.php'],　{interval: 0}, browserSync.reload);
